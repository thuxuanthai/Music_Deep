...
parent.setSectionTitle("Facial Emotion Angry");
...
class Song {
    ...
    getSrc() {
        return `../static/my_lib_angry/audio/${this.id}.mp3`;
    }

    getPoster() {
        return `../static/my_lib_angry/img_lib/${this.id}.jpg`;
    }

    play() {
        let song_thumbnail = this.getPoster();
...
// create Array
var songs = [
    new Song(1, "Chú Đại Bi Vô Lượng", "Masew Khoi Vu"),
    new Song(2, "Cứ Thở Đi", "Đức Phúc x Juky San"),
    new Song(3, "Đến Giờ Cơm", "Ái Phương"),
    new Song(4, "Đôi Mươi", "Hoàng Dũng x GDucky"),
    new Song(5, "Hít Vào Thở Ra", "Min x HieuThuHai"),
