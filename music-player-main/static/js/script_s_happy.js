...
parent.setSectionTitle("Facial Emotion  Happy");
...
class Song {
    ...
    getSrc() {
        return `../static/my_lib_happy/audio/${this.id}.mp3`;
    }

    getPoster() {
        return `../static/my_lib_happy/img_lib/${this.id}.jpg`;
    }
...
// create Array
var songs = [
    new Song(1, "Đường Vào Tim Em", "T.A.P, DUTZUX"),
    new Song(2, "Mưa Tháng Sáu", "Văn Mai Hương"),
    new Song(3, "Nấu Ăn Cho Em", "Đen Ft. PiaLinh"),
    new Song(4, "Reality", "Mortals"),
    new Song(5, "Vì Một Câu Nói", "Hoàng Dũng"),
