import { fetchHomepage, fetchSongDetails } from "./api-requests.js";
import { addLastPlayedSongObject } from "./last-played.js";
...
// tạo nội dung khi tải trang
await generateHomepageContent()

// đính kèm người nghe sự kiện nội dung:
...
// sử dụng ủy quyền sự kiện để xử lý các sự kiện thẻ
