import { addLanguage, removeLanguage, getLanguageArray } from "./language.js";
...
// set initial song
playAudio("../static/assets/rickroll.mp3", "Never Gonna Give You Up", "Rick Astley", "../static/assets/rickroll.jpg");
...
//Thu xuan code
// function searchForE(rs) {
//     iframe.addEventListener("load", () => {
//             let iframe_functions = iframe.contentWindow;
//             iframe_functions.generateSearch(rs);
//         },
//         { once: true }
//     );

//     navTo("search-emotion");
// }


// function searchSubmitEventE(event) {
...
// let form_elementE = document.querySelector("#search_form");
// form_elementE.addEventListener("submit",searchForE);
