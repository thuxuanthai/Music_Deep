...
parent.setSectionTitle("Facial Emotion  Neutral");
...
class Song {
    ...
    getSrc() {
        return `../static/my_lib_neutral/audio/${this.id}.mp3`;
    }

    getPoster() {
        return `../static/my_lib_neutral/img_lib/${this.id}.jpg`;
    }
...
// create Array
var songs = [
    new Song(1, "Để Tôi Ôm Em Bằng Giai Điệu Này - KAI ĐINH x MIN x GREY D", "Kai Định x Min x Grey D"),
    new Song(2, "Đi Về Nhà", "Đen x JustaTee"),
    new Song(3, "Điều Buồn Nhất", "Kai Đinh"),
